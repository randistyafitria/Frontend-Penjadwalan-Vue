    ...
    <div class="container-fluid mt-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        DATA WAKTU TIDAK BERSEDIA
                        <hr>
                        <router-link :to="{name: 'waktu_tidak_bersedia.create'}" class="btn btn-md btn-success">TAMBAH WAKTU TIDAK BERSEDIA</router-link>
                        ...
                        <table class="table table-striped table-bordered mt-4">
                            ...
                            <tbody>
                                ...
                                <tr v-for="(wkt_tdk_bersedia, index) in wkt_tdk_bersedias" :key="index">
                                    <td>{{ wkt_tdk_bersedia.kode_dosen }}</td>
                                    <td>{{ wkt_tdk_bersedia.kode_hari }}</td>
                                    <td>{{ wkt_tdk_bersedia.kode_jam }}</td>
                                    <td class="text-center">
                                        <router-link :to="{name: 'waktu_tidak_bersedia.edit', params:{kode: wkt_tdk_bersedia.kode }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
                                        <button @click.prevent="wkt_tdk_bersediaDelete(wkt_tdk_bersedia.kode)" class="btn btn-sm btn-danger ml-1">DELETE</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table> 
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            .then(response => {
              ...
              //assign state wkt_tdk_bersedias with response data
              wkt_tdk_bersedias.value = response.data.data
        ...
        //method delete
            function wkt_tdk_bersediaDelete(kode) {
            
            //delete data wkt_tdk_bersedia by ID
            axios.delete(`http://localhost:8000/api/waktu_tidak_bersedia/${kode}`)
            .then(() => {
              
              //splice wkt_tdk_bersedias 
              wkt_tdk_bersedias.value.splice(wkt_tdk_bersedias.value.indexOf(kode), 1);
