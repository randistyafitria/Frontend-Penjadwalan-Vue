                            ...
                            <tbody>
                                ...
                                <tr v-for="(dosen, index) in dosens" :key="index">
                                    ...
                                    <td class="text-center">
                                        <router-link :to="{name: 'dosen.edit', params:{kode: dosen.kode }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
                                        <button @click.prevent="dosenDelete(dosen.kode)" class="btn btn-sm btn-danger ml-1">DELETE</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table> 
    ...
    setup() {
        ...
        //method delete
            ...
            .then(() => {
              ...
              //splice dosens 
              dosens.value.splice(dosens.value.indexOf(kode), 1);
