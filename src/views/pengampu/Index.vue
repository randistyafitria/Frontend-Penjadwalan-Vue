                        ...
                        <table class="table table-striped table-bordered mt-4">
                            ...
                            <tbody>
                                ...
                                <tr v-for="(pengampu, index) in pengampus" :key="index">
                                    <td>{{ pengampu.kode_mk }}</td>
                                    <td>{{ pengampu.kode_dosen }}</td>
                                    <td>{{ pengampu.kelas }}</td>
                                    <td>{{ pengampu.tahun_akademik }}</td>
                                    <td class="text-center">
                                        <router-link :to="{name: 'pengampu.edit', params:{kode: pengampu.kode }}" class="btn btn-sm btn-primary mr-1">EDIT</router-link>
                                        <button @click.prevent="pengampuDelete(pengampu.kode)" class="btn btn-sm btn-danger ml-1">DELETE</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table> 
    ...
    setup() {
        ...
        //method delete
            ...
            .then(() => {
              ...
              //splice pengampus 
              pengampus.value.splice(pengampus.value.indexOf(kode), 1);
